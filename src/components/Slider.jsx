...
const Slider = ({data}) => {
  ...
  return (
    <div className="flex justify-center items-center gap-2">
      ...
      <div className="grid grid-rows-1 grid-flow-col-dense justify-between items-center gap-4 overflow-x-scroll w-full lg:w-[78vw]  px-5 scroll-hide" ref={scrollRef}>
    {
